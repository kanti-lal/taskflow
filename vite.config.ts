        ...
        return [
          {
            ...
            injectTo: "head",
            children: `
            // Report any logs, errors, etc to the parent kanti app context to include in
            // the bottom panel.
      ...
      transform(src: string, id: string) {
        if (id === "/app/src/main.tsx") {
          return `
            ${src}
            if (process.env.NODE_ENV === 'development') {
              // Report any vite-hmr errors up to the parent kanti app context
